...
# heavy_data_4g_low_env = correct_dict_values(convert_txt_into_dict(open('light-data/4g-low.txt')))
...
a = heavy_data_4g_medium_env
b = heavy_data_3g_medium_env
c = light_data_2g_low_env
...
plt.title('Comparison in Medium env (Heavy data)')
...
# plt.gca().legend((f'High env ({first_mean_value})', f'Medium env ({second_mean_value})'), loc='upper right')
